...
return {
Lock     = '• اهلا ي ← 「 '..UserInfousername..'  」\n'..TextMsg,
unLock   = '• اهلا ي ← 「 '..UserInfousername..'  」\n'..TextMsg,
lockKtm  = '• اهلا ي ← 「 '..UserInfousername..'  」\n'..TextMsg..'\n• خاصيه الكتم ',
lockKid  = '• اهلا ي ← 「 '..UserInfousername..'  」\n'..TextMsg..'\n• خاصيه التقييد ',
lockKick = '• اهلا ي ← 「 '..UserInfousername..'  」\n'..TextMsg..'\n• خاصيه الطرد ',
...
Redis:del(FDFGERB.."FDFGERB:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(FDFGERB.."FDFGERB:Game:Estimate"..msg.chat_id..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• خسرت بلعبه يحلو \n• حظآ اوفر في المره القادمه \n• كان الرقم الذي تم تخمينه  "..GETNUM.." ","md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"• تخمينك غلط ↓ \n• ارسل رقم تخمنه مره اخرى ","md",true)  
end
end
end
end
...
if text == 'تعطيل مغادره اريك' then
if not msg.ControllerBot then 
...
return LuaTele.sendText(msg_chat_id,msg_id," • تم تعطيل مغادره اريك ","md",true)
end
if text == 'تفعيل مغادره اريك' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• هاذا الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:set(FDFGERB.."FDFGERB:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," • تم تفعيل مغادره اريك للمطورين ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• اريك مفعل من قبل \n• المجموعه ← ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') ',"md",true)  
else
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• تم تفعيل اريك استمتع \n• المجموعه ← ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') ','md', true, false, false, false, reply_markup)
end
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,'• رابط الحذف استعجل وحذف   ',"md",false, false, false, false, reply_markup)
end
...
Jabwaiusername = '• الحلو هذا ← ['..bain.first_name..'](tg://user?id='..bain.id..')\n• طلب الزواج من ← ['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')\nموافقه ع زواج؟\n'
else
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعلت صورتي ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n• هييه ما يمديك تقيد ل"..Controller(msg_chat_id,Message_Reply.sender.user_id).."  ","md",true)  
end
...
data = {
{
{text = '• 𝐄𝐫𝐢𝐜 𝐒𝐨𝐮𝐫𝐜𝐞', url = 't.me/LDD7D'}, 
},
}
}
...
{
{text = ' ³ ', data = msg.sender.user_id..'/help3'}, {text = 'اوامر التسليه', data = msg.sender.user_id..'/help4'}, 
},
{
...
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'• يلا بطلع بدك ضيفني ورفعني مشرف  ',"md")
...
return LuaTele.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح به هو 100  ريال 💸 \n-","md",true)
end
ballancee = Redis:get(FDFGERB.."nool:flotysb"..msg.sender.user_id) or 0
...
Jabwaiusername = '• تقدرون تفلونها الحين ولا تنسون ليلة الدخله .  \n• مبروك ل العريس ← ['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
Jabwaiusername = 'لا يوجد'
end
...
data = {
{
{text = '𝐄𝐫𝐢𝐜 𝐒𝐨𝐮𝐫𝐜𝐞', url='https://t.me/LDD7D'},
},
{
...
{
{text = ' ³ ', data = IdUser..'/help3'}, {text = 'اوامر التسليه', data = IdUser..'/help4'}, 
},
{
